...
*OBJECTIVE*:
Please review the report assets and the client context above.
...
Please write me x3 prompts to generate relevant images based on the clients business sector, business activities but to encapsulate the general theme of the report assets.
...
json
{{
  "First Main Image Prompt": "...",
}},
{{
  "Second Main Image Prompt": "...",
}},
{{
  "Third Main Image Prompt": "...",
}}
