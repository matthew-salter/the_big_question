...
def run_prompt(data):
    try:
        ...
        data["run_id"] = run_id  # Return run_id immediately
        ...
        with open("Prompts/Predictive_Report/prompt_2_section_assets.txt", "r", encoding="utf-8") as f:
            template = f.read()
        ...
        supabase_path = f"The_Big_Question/Predictive_Report/Ai_Responses/Prompt_2_Section_Assets/{run_id}.txt"
        ...
        return {"status": "error", "message": "Failed to write Prompt 2 Section Assets"}
