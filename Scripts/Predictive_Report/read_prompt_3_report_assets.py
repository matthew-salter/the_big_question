...
def run_prompt(data):
    try:
        ...
        while retries < MAX_RETRIES:
            try:
                ...
                return {
                    "status": "success",
                    "run_id": run_id,
                    "prompt_3_report_assets": flattened
                }
        ...
        return {
            "status": "error",
            "run_id": run_id,
            "message": "Prompt 3 Report Assets file not yet available. Try again later."
        }

    except Exception as e:
        logger.exception("Unhandled error in read_prompt_3_report_assets")
        return {
            "status": "error",
