...
def run_prompt(data):
    try:
        ...
        supabase_path = f"The_Big_Question/Predictive_Report/Ai_Responses/Prompt_5_Combine/{run_id}.txt"
        ...
        return {
            "status": "error",
            "run_id": run_id,
            "message": "Prompt 5 Combine file not yet available. Try again later."
        }

    except Exception as e:
        logger.exception("Unhandled error in read_prompt_5_combine")
        return {
            "status": "error",
