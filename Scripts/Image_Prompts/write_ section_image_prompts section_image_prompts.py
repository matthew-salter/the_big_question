...
def run_prompt(data):
    try:
        ...
        with open("Prompts/Image_Prompts/section_image_prompts.txt", "r", encoding="utf-8") as f:
            template = f.read()
        ...
        supabase_path = f"The_Big_Question/Predictive_Report/Ai_Responses/Section_Image_Prompts/{run_id}.txt"
        ...
        return {"status": "error", "message": "Failed to write Section Image Prompts"}
