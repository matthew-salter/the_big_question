...
def call_openai_responses(
    ...
    *,
    ...
    NOTE: Keep args SDK-compatible (no 'verbosity', no 'reasoning_effort' on older SDKs like openai==2.6.1).
    """
    max_tries = 6
    base_sleep = 1.0
    ...
    for attempt in range(1, max_tries + 1):
        try:
            ...
            # Defensive retry without any optional kwargs if someone re-adds them later.
