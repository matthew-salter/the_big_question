...
# Observed only; not passed to Responses API
...
def call_openai_responses(
    ...
    temperature: float = TEMPERATURE,  # kept for signature only; not used
    *,
    ...
    Do NOT pass 'temperature' (some SDK/model combos reject it).
    """
